...
#Preview {
    RecreationalView(recreationalViewModel: RecreationalViewModel(apiClient:  APIService(urlSession: URLSessionAdapter(session: .shared)), apiRequestBuilder: APIRequestBuilder(baseURL: BaseURLProviderFactory.provider(for: .test).baseURL)

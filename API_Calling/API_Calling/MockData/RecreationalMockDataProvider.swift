//
//  RecreationalMockDataProvider.swift
//  API_Calling
//
...
struct RecreationalMockDataProvider {
    let playerJsonFetcher : JSONFetcherProtocol
    var mockUserList: [RecreationalPlayerModel] {
        do {
            return try playerJsonFetcher.fetchJson(from: "RecreationalPlayersMockData", as: [RecreationalPlayerModel].self)
